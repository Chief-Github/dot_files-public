...
PanelWindow {
    ...
    readonly property color cSurface: Qt.rgba(pywal.background.r, pywal.background.g, pywal.background.b, 0.48) //0.18
    readonly property color cSurfaceContainer: Qt.rgba(pywal.background.r, pywal.background.g, pywal.background.b, 0.58) //0.18
