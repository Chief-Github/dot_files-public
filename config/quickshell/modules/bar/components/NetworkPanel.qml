...
FocusScope {
    ...
    readonly property bool passwordDialogVisible: passwordDialog.isOpen
    ...
    readonly property color cSurface: Qt.rgba(pywal.background.r, pywal.background.g, pywal.background.b, 0.78)
    readonly property color cSurfaceContainer: Qt.rgba(Qt.lighter(pywal.background, 1.15).r, Qt.lighter(pywal.background, 1.15).g, Qt.lighter(pywal.background, 1.15).b, 0.78)
