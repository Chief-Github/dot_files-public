...
Item {
    ...
    // Background click area — opens popup when clicking art or anywhere not a button
    MouseArea {
        anchors.fill: parent
        z: -1
        visible: hasPlayer
        ...
        onClicked: {
            if (root.mediaPlayerPopup)
                root.mediaPlayerPopup.shouldShow = !root.mediaPlayerPopup.shouldShow
        }
    }
    ...
    RowLayout {
        ...
        // Album Art thumbnail (spinning circle)
        Rectangle {
            id: artCircle
            ...
            RotationAnimation on rotation {
                ...
                from: artCircle.rotation
                to: artCircle.rotation + 360
                duration: 5000
