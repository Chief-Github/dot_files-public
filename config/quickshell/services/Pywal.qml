...
Singleton {
    ...
    readonly property real surfaceAlpha: 0.20

    // Surface colors — semi-transparent so Hyprland blur shows through
    readonly property color surface: Qt.rgba(Qt.lighter(background, 1.03).r, Qt.lighter(background, 1.03).g, Qt.lighter(background, 1.03).b, surfaceAlpha)
    readonly property color surfaceDim: Qt.rgba(Qt.darker(background, 1.08).r, Qt.darker(background, 1.08).g, Qt.darker(background, 1.08).b, surfaceAlpha)
    readonly property color surfaceBright: Qt.rgba(Qt.lighter(background, 1.12).r, Qt.lighter(background, 1.12).g, Qt.lighter(background, 1.12).b, surfaceAlpha)
    readonly property color surfaceContainer: Qt.rgba(Qt.lighter(background, 1.1).r, Qt.lighter(background, 1.1).g, Qt.lighter(background, 1.1).b, surfaceAlpha)
    readonly property color surfaceContainerLow: Qt.rgba(Qt.lighter(background, 1.06).r, Qt.lighter(background, 1.06).g, Qt.lighter(background, 1.06).b, surfaceAlpha)
    readonly property color surfaceContainerHigh: Qt.rgba(Qt.lighter(background, 1.16).r, Qt.lighter(background, 1.16).g, Qt.lighter(background, 1.16).b, surfaceAlpha)
    readonly property color surfaceContainerHighest: Qt.rgba(Qt.lighter(background, 1.22).r, Qt.lighter(background, 1.22).g, Qt.lighter(background, 1.22).b, surfaceAlpha)
    ...
    // Trigger file — matugen touches this after writing colors.json
    // Needed because matugen does an atomic rename which bypasses inotify on the original path
    FileView {
        path: "/tmp/.qs_color_trigger"
        watchChanges: true
